...
class ShoesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create shoe" do
    assert_difference("Shoe.count") do
      post shoes_url, params: { shoe: { active: @shoe.active, brand: @shoe.brand, category: @shoe.category, name: @shoe.name, size: @shoe.size } }
    end
  ...
  test "should update shoe" do
    patch shoe_url(@shoe), params: { shoe: { active: @shoe.active, brand: @shoe.brand, category: @shoe.category, name: @shoe.name, size: @shoe.size } }
